...
begin
  wbRecord(AVIF, 'Actor Value Information', [
    ...
    wbFULL,
    wbDESCReq,
    wbLString(ANAM, 'Abbreviation', 0, cpTranslate),  // 0x160
    wbFloat(NAM0, 'Unknown'), // Prior to form version 81, it was either 0.0, 1.0 or 100.0, so scale or multiplier ? // 0x184
    wbInteger(AVFL, 'Unknown', itU32), // 32 bits Flags, it used to impact NAM0 loading (bits 10, 11, 12) (even though it loads later :) ) // 0x16C
    wbInteger(NAM1, 'Unknown', itU32)  // 0x170

...
function TwbFile.GetIsTemporary: Boolean;
begin
  Result := fsIsTemporary in flStates;
end;
...
procedure TwbFile.SetIsTemporary(Value: Boolean);
begin
  if Value then
    Include(flStates, fsIsTemporary)
  else
    Exclude(flStates, fsIsTemporary);
end;

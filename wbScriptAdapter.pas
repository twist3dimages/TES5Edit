...
procedure IwbElement_PersistentName(var Value: Variant; Args: TJvInterpreterArgs);
var
  Element: IwbElement;
begin
  Value := '';
  if Supports(IInterface(Args.Values[0]), IwbElement, Element) then
    Value := Element.PersistentName;
end;
...
begin
  with JvInterpreterAdapter do begin
    ...
    AddFunction(cUnit, 'PersistentName', IwbElement_PersistentName, 1, [varEmpty], varEmpty);
